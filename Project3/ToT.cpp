...
void _GameMode::Credits(ToT_Window &main_window)
{
...
void _GameMode::Options(ToT_Window &main_window)
{
...
void _GameMode::Ranking(ToT_Window &main_window)
{
...
void _GameMode::Game(bool multiplayer, ToT_Window &main_window)
{
