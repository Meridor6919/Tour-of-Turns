...
namespace LanguagePack
{
	std::vector<std::vector<std::string>> vector_of_strings = {
		...
		{ "New Game ", "Multiplayer ", "Ranking ", "Options ", "Credits ", "Exit" },
		...
		{ "Hello I am Michal Balicki and I am really happy that you are playing my game.", "Tour of Turns was my first real project in my programming way and I hope you like it.",
			"I would like to thank people who helped me with this project.", "Krystian Grzegorzewicz ", "without him the game wouldn't be created.",
			"He was patiently listening what problems do I have with ToT and the most important he gave me a main idea of the game.", "Marek Loek ", "for making an icon image and inspiring me to hard work.",
			"Marcin Marzec ", "for giving me inspiration.", "I admire how much work he put into Pan Zniszczenia and Zniwiarz Dusz maps for HoMM3 based on Diablo universe.", "Miroslaw Zelent ", "for getting me interested in programming"},
		{ "on", "off" },
