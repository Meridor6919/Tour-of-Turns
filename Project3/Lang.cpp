...
namespace LanguagePack
{
	std::vector<std::vector<std::string>> vector_of_strings = {
		...
		{ "Introduction", "Tours", "Cars", "Tires", "Gameplay Formulas"},
		...
		{ "", "Tires provide parameters strictly connected to type of the terrain. There are exactly six of them - as many as terrain types",
			...
			"Friction", " - Alterates attributes responsible for speed modulation. Basically better probability of passing the tests - widder the modulation range Specific calculations are available in \"Gameplay Formulas\" panel",
		...
		{ "Tour of Turns's"," game mechanics are inherently based on math. There are no dexterity involved, pure analysis. Every part of gameplay has its own formulas. Order in which this events take place look like this: ",
			"Attacking segment", " - This part starts with the beggining of the second turn. Players choose targets that have score, higher up to 6 points and lower up to 4 points. (Player with the lowest score is on the lead)",
			...
			"", "durability_lost = over_speed * (level + level * level) / 2 where level is an intager rounded down from over_speed / maximum speed * 20 + 10",
