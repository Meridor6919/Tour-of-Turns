...
MeridorConsoleLib::Text::Internal::ChooseText::ChooseText(TextChooseDesc& choose_desc, const TextInfo& window_info) : ChooseInterface(choose_desc, window_info)
{
...
std::string MeridorConsoleLib::Text::ChooseText(TextChooseDesc& choose_desc, const TextInfo& window_info)
{
	Internal::ChooseText choose_impl(choose_desc, window_info);
	return Internal::GenericChoose(choose_impl);
}

std::string MeridorConsoleLib::Text::ChooseText(TextChooseDesc& choose_desc, const TextInfo& window_info, const MultithreadingData& multithreading_data)
{
	Internal::ChooseText choose_impl(choose_desc, window_info);
