...
int MeridorConsoleLib::Text::Infobox::GetMaxRecords()
{
	return (infobox_desc->box_size.Y - 1) / infobox_desc->vertical_spacing;
}
void MeridorConsoleLib::Text::Infobox::CorrectContainerSize()
{
...
void MeridorConsoleLib::Text::Infobox::CorrectTextSize(std::string& text, short& remaining_space)
{
...
void MeridorConsoleLib::Text::Infobox::ShowDataRecord(Color main_color, Color secondary_color, short index)
{
...
MeridorConsoleLib::Text::Infobox::Infobox(InfoboxDesc& infobox_desc, const MeridorConsoleLib::Text::WindowInfo& window_info)
{
...
void MeridorConsoleLib::Text::Infobox::Draw(const MultithreadingData& multithreading_data)
{
	multithreading_data.mutex->lock();
	Draw();
	multithreading_data.mutex->unlock();
}
void MeridorConsoleLib::Text::Infobox::DrawBox(const MultithreadingData& multithreading_data)
{
	multithreading_data.mutex->lock();
	DrawBox();
	multithreading_data.mutex->unlock();
}
void MeridorConsoleLib::Text::Infobox::ClearBox(const MultithreadingData& multithreading_data)
{
	multithreading_data.mutex->lock();
	ClearBox();
	multithreading_data.mutex->unlock();
