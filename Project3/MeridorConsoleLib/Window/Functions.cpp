...
void MeridorConsoleLib::Window::BlockingSleep(int miliseconds)
{
...
void MeridorConsoleLib::Window::SetCursor(HANDLE output_handle, BOOL visible)
{
...
bool MeridorConsoleLib::Window::IsMinimizeButtonPressed(HANDLE input_handle)
{
...
LONG MeridorConsoleLib::Window::GetWindowFlags(WindowMode window_mode)
{
	switch (window_mode)
	{
