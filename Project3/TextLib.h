...
namespace Text
{
	...
	namespace Choose
	{
		int Horizontal(const std::vector<std::string> text, int starting_position, const COORD starting_point, const TextAlign text_align, const bool clear_after, Window &main_window, std::mutex *mutex, char defalut_value = '0', int delay = 20, bool *loop = nullptr);
		...
		int Veritcal(const std::vector<std::string> text, short starting_position, const COORD starting_point, const short spacing, const TextAlign text_align, const bool clear_after, Window &main_window, std::mutex *mutex, char defalut_value = '0', int delay = 20, bool *loop = nullptr);
		...
		int Numeric(const int max, COORD starting_point, const bool zero_allowed, Window &main_window, std::mutex *mutex, char defalut_value = '0', int delay = 20, bool *loop = nullptr);
